...
// notes
  ...
  ngOnInit() {
    ...
    TweenMax.set(gP, { fill: 'hsl(137, 50%, 50%)', opacity: 0.5, y: -20 });
    TweenMax.set(gA, { fill: 'hsl(137, 50%, 50%)', opacity: 0.5, y: 90 });
    TweenMax.set(gD, { fill: 'hsl(137, 50%, 50%)', opacity: 0.5, y: 200 });
    TweenMax.set(rP, { fill: 'hsl(0, 50%, 50%)', opacity: 0.5, y: -20 });
    TweenMax.set(rA, { fill: 'hsl(0, 50%, 50%)', opacity: 0.5, y: 90 });
    TweenMax.set(rD, { fill: 'hsl(0, 50%, 50%)', opacity: 0.5, y: 200 });
